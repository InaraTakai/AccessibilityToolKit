...
let card1 = Card(title: .Noticeable, level: .A, code: "1.1.1", guideline: NSLocalizedString("Alternativas em texto", comment: "Diretriz"), criterion: NSLocalizedString("Conteúdo não textual", comment: "Critério de Sucesso"), description: NSLocalizedString("Todo conteúdo “não textual” deve trazer uma alternativa em texto para identificar o conteúdo. Nota: a não ser que o conteúdo seja apenas decorativo ou represente uma das exceções descritas no critério completo (captcha e imagens de teste, inclusive).", comment: "Descrição resumidada diretriz"), link: nil)

let card2 = Card(title: .Noticeable, level: .A, code: "1.2.1", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Apenas áudio ou apenas vídeo (pré-gravado)", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser fornecida uma alternativa para o conteúdo apresentado: Apenas áudio: fornecer transcrição descritiva em texto; Apenas vídeo: fornecer áudio alternativo e/ou transcrição descritiva em texto;", comment: "Descrição resumidada diretriz"), link: nil)

let card3 = Card(title: .Noticeable, level: .A, code: "1.2.2", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Legendas (pré-gravado)", comment: "Critério de Sucesso"), description: NSLocalizedString("Devem ser fornecidas legendas para todo conteúdo que contenha áudio pré-gravado (apenas áudio ou vídeo com áudio).", comment: "Descrição resumidada diretriz"), link: nil)

let card4 = Card(title: .Noticeable, level: .A, code: "1.2.3", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Audiodescrição ou mídia alternativa (pré-gravado)", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser fornecida audiodescrição ou uma transcrição descritiva em texto para todo conteúdo em vídeo pré-gravado. Nota: se for fornecida audiodescrição, o critério 1.2.5 (AA) estará atendido. Se for fornecida uma mídia alternativa, o critério 1.2.8 (AAA) estará atendido.", comment: "Descrição resumidada diretriz"), link: nil)

let card5 = Card(title: .Noticeable, level: .AA, code: "1.2.4", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Legendas (ao vivo)", comment: "Critério de Sucesso"), description: NSLocalizedString("Devem ser fornecidas legendas para todo conteúdo que contenha áudio ao vivo (apenas áudio ou vídeo com áudio).", comment: "Descrição resumidada diretriz"), link: nil)

let card6 = Card(title: .Noticeable, level: .AA, code: "1.2.5", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Audiodescrição (pré-gravado)", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser fornecida audiodescrição para todo conteúdo em vídeo pré-gravado. Nota: ver em conjunto com critério 1.2.7. Nota 2: ao atender este critério, o critério 1.2.3 (A) também estará atendido.", comment: "Descrição resumidada diretriz"), link: nil)

let card7 = Card(title: .Noticeable, level: .AAA, code: "1.2.6", guideline: NSLocalizedString("Multimídia baseada em tempo", comment: "Diretriz"), criterion: NSLocalizedString("Língua de sinais", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser fornecida interpretação em língua de sinais (exemplo: Libras) para todo conteúdo que contenha áudio pré-gravado.", comment: "Descrição resumidada diretriz"), link: nil)
...
let card29 = Card(title: .Noticeable, level: .AA, code: "1.4.13", guideline: NSLocalizedString("Discernível", comment: "Diretriz"), criterion: NSLocalizedString("Conteúdo em foco por mouse ou teclado", comment: "Critério de Sucesso"), description: NSLocalizedString("Conteúdos adicionais (exemplo: tooltip ou sub-menu) não devem ser acionados apenas com foco por mouse (mouseover) ou teclado. Caso isso ocorra, certas condições devem ser atendidas. Nota: ver critério completo para verificar as condições.", comment: "Descrição resumidada diretriz"), link: nil)

let card30 = Card(title: .Operable, level: .A, code: "2.1.1", guideline: NSLocalizedString("Acessível por teclado", comment: "Diretriz"), criterion: NSLocalizedString("Teclado", comment: "Critério de Sucesso"), description: NSLocalizedString("Toda funcionalidade deve estar disponível para utilização com teclado, a menos que a funcionalidade não possibilite o controle apenas por teclado.", comment: "Descrição resumidada diretriz"), link: nil)

let card31 = Card(title: .Operable, level: .A, code: "2.1.2", guideline: NSLocalizedString("Acessível por teclado", comment: "Diretriz"), criterion: NSLocalizedString("Sem bloqueio de teclado", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser possível navegar de e para todos os elementos sem qualquer tipo de bloqueio de teclado.", comment: "Descrição resumidada diretriz"), link: nil)

let card32 = Card(title: .Operable, level: .AAA, code: "2.1.3", guideline: NSLocalizedString("Acessível por teclado", comment: "Diretriz"), criterion: NSLocalizedString("Teclado (sem exceção)", comment: "Critério de Sucesso"), description: NSLocalizedString("Toda funcionalidade deve estar disponível para utilização com teclado. Nota: ao atender este critério, o critério 2.1.1 (A) também estará atendido.", comment: "Descrição resumidada diretriz"), link: nil)

let card33 = Card(title: .Operable, level: .AA, code: "2.1.4", guideline: NSLocalizedString("Acessível por teclado", comment: "Diretriz"), criterion: NSLocalizedString("Atalhos de teclado por caractere", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve-se evitar a criação de atalhos de teclado utilizando apenas simples caracteres (letras, números, pontuações, etc). Caso isso ocorra, certas condições devem ser atendidas. Nota: ver critério completo para verificar as condições.", comment: "Descrição resumidada diretriz"), link: nil)

let card34 = Card(title: .Operable, level: .A, code: "2.2.1", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Ajustável por limite de tempo", comment: "Critério de Sucesso"), description: NSLocalizedString("Se uma aplicação possui um limite de tempo, o usuário deve ter opções para desligar ou ajustar o tempo. A não ser que seja uma situação onde o tempo seja essencial. Nota: recomendado utilizar em conjunto com critério 2.2.6.", comment: "Descrição resumidada diretriz"), link: nil)

let card35 = Card(title: .Operable, level: .A, code: "2.2.2", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Colocar em pausa, parar ou ocultar", comment: "Critério de Sucesso"), description: NSLocalizedString("Qualquer componente com movimento automático que dure mais do que 5 segundos e seja apresentado em conjunto com outro conteúdo, pode ser pausado, parado ou ocultado pelo usuário.", comment: "Descrição resumidada diretriz"), link: nil)

let card36 = Card(title: .Operable, level: .AAA, code: "2.2.3", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Sem limite de tempo", comment: "Critério de Sucesso"), description: NSLocalizedString("Nenhuma funcionalidade deve possuir limite de tempo para que uma ação seja executada.", comment: "Descrição resumidada diretriz"), link: nil)

let card37 = Card(title: .Operable, level: .AAA, code: "2.2.4", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Interrupções", comment: "Critério de Sucesso"), description: NSLocalizedString("Qualquer tipo de interrupção no conteúdo que possa confundir o usuário deve possuir um mecanismo que permita o seu desligamento ou adiamento, a não ser que envolva uma emergência que preserve a saúde, segurança ou bens do usuário.", comment: "Descrição resumidada diretriz"), link: nil)

let card38 = Card(title: .Operable, level: .AAA, code: "2.2.5", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Nova autenticação", comment: "Critério de Sucesso"), description: NSLocalizedString("Caso uma sessão autenticada expire, qualquer usuário logado deve ser capaz de continuar sua atividade sem qualquer perda de dados, ao se efetuar uma nova autenticação no ambiente.", comment: "Descrição resumidada diretriz"), link: nil)

let card39 = Card(title: .Operable, level: .AAA, code: "2.2.6", guideline: NSLocalizedString("Tempo suficiente", comment: "Diretriz"), criterion: NSLocalizedString("Limites de tempo", comment: "Critério de Sucesso"), description: NSLocalizedString("Caso a inatividade do usuário resulte em perda de dados preenchidos anteriormente, ele deverá saber qual é o tempo limite (e restante) antes que ocorra a perda automática de dados. A menos que esse limite seja superior a 20 horas. Nota: recomendado utilizar em conjunto com critério 2.2.1.", comment: "Descrição resumidada diretriz"), link: nil)

let card40 = Card(title: .Operable, level: .A, code: "2.3.1", guideline: NSLocalizedString("Ataques epiléticos", comment: "Diretriz"), criterion: NSLocalizedString("Três flashes ou abaixo do limite", comment: "Critério de Sucesso"), description: NSLocalizedString("Nenhum conteúdo da página deve piscar mais do que 3 vezes por segundo, a não ser que os flashes estejam em baixo contraste ou possuam pouco vermelho.", comment: "Descrição resumidada diretriz"), link: nil)

let card41 = Card(title: .Operable, level: .AAA, code: "2.3.2", guideline: NSLocalizedString("Ataques epiléticos", comment: "Diretriz"), criterion: NSLocalizedString("Três flashes", comment: "Critério de Sucesso"), description: NSLocalizedString("Nenhum conteúdo da página deve piscar mais do que 3 vezes por segundo.", comment: "Descrição resumidada diretriz"), link: nil)

let card42 = Card(title: .Operable, level: .AAA, code: "2.3.3", guideline: NSLocalizedString("Ataques epiléticos", comment: "Diretriz"), criterion: NSLocalizedString("Animações de interações", comment: "Critério de Sucesso"), description: NSLocalizedString("Qualquer tipo de animação de interação não essencial e acionada pelo usuário (exemplo: rolagem com efeito parallax) deve ter um mecanismo para que o usuário desligue a animação. Nota: diferentemente do critério 2.2.2, este refere-se ao acionamento pelo próprio usuário.", comment: "Descrição resumidada diretriz"), link: nil)

let card43 = Card(title: .Operable, level: .A, code: "2.4.1", guideline: NSLocalizedString("Navegável", comment: "Diretriz"), criterion: NSLocalizedString("Ignorar blocos", comment: "Critério de Sucesso"), description: NSLocalizedString("Um mecanismo deve ser fornecido para ignorar blocos de conteúdo que são repetidos em diferentes telas e fluxos. Nota: este critério poderá ser considerado atendido nos casos em que houver uma adequada estrutura de cabeçalhos. Ver critérios 2.4.2 e 2.4.10.", comment: "Descrição resumidada diretriz"), link: nil)
...
let card54 = Card(title: .Operable, level: .A, code: "2.5.2", guideline: NSLocalizedString("Modalidade de Entrada", comment: "Diretriz"), criterion: NSLocalizedString("Cancelamento de acionamento", comment: "Critério de Sucesso"), description: NSLocalizedString("Deve ser possível cancelar ou reverter qualquer ação que envolva clique ou toque simples. Algumas condições precisam ser atendidas. Nota: ver critério completo para verificar as condições.", comment: "Descrição resumidada diretriz"), link: nil)

let card55 = Card(title: .Operable, level: .A, code: "2.5.3", guideline: NSLocalizedString("Modalidade de Entrada", comment: "Diretriz"), criterion: NSLocalizedString("Rótulo no nome acessível", comment: "Critério de Sucesso"), description: NSLocalizedString("Qualquer rótulo (label) visível deve ser lido exatamente da mesma forma por leitores de tela. Caso haja descrição adicional, o rótulo visível deverá ser o primeiro a ser lido (exemplo: em um botão, cujo rótulo seja 'compre já', a leitura deverá ser semelhante a 'compre já o produto XYZ'). Nota: ver critério completo.", comment: "Descrição resumidada diretriz"), link: nil)

let card56 = Card(title: .Operable, level: .A, code: "2.5.4", guideline: NSLocalizedString("Modalidade de Entrada", comment: "Diretriz"), criterion: NSLocalizedString("Atuação em movimento", comment: "Critério de Sucesso"), description: NSLocalizedString("Qualquer funcionalidade que exija a movimentação do aparelho (exemplo: “agitar para desfazer”) deve oferecer um mecanismo para ser desativada e caso seja uma função essencial, a interface deve oferecer uma alternativa de acionamento.", comment: "Descrição resumidada diretriz"), link: nil)

let card57 = Card(title: .Operable, level: .AAA, code: "2.5.5", guideline: NSLocalizedString("Modalidade de Entrada", comment: "Diretriz"), criterion: NSLocalizedString("Tamanho da área clicável", comment: "Critério de Sucesso"), description: NSLocalizedString("O tamanho de áreas clicáveis devem ser de ao menos 44x44 pixels, a não ser que a área clicável esteja em uma frase ou bloco de texto", comment: "Descrição resumidada diretriz"), link: nil)

let card58 = Card(title: .Operable, level: .AAA, code: "2.5.6", guideline: NSLocalizedString("Modalidade de Entrada", comment: "Diretriz"), criterion: NSLocalizedString("Mecanismos de entrada simultâneos", comment: "Critério de Sucesso"), description: NSLocalizedString("Não deve-se restringir o uso de dispositivos diferentes para se operar uma plataforma (exemplo: usuários com deficiência motora, podem acoplar um teclado móvel a um celular para operá-lo), a não ser que essa restrição seja essencial ou necessária para se garantir a segurança do conteúdo.", comment: "Descrição resumidada diretriz"), link: nil)

let card59 = Card(title: .Understandable, level: .A, code: "3.1.1", guideline: NSLocalizedString("Legível", comment: "Diretriz"), criterion: NSLocalizedString("Idioma da página", comment: "Critério de Sucesso"), description: NSLocalizedString("O idioma do conteúdo deve ser definido em cada uma das páginas ou telas da aplicação.", comment: "Descrição resumidada diretriz"), link: nil)

let card60 = Card(title: .Understandable, level: .AA, code: "3.1.2", guideline: NSLocalizedString("Legível", comment: "Diretriz"), criterion: NSLocalizedString("Idioma das partes", comment: "Critério de Sucesso"), description: NSLocalizedString("O idioma de um determinado trecho ou frase contendo idioma diferente do original da página ou tela atual, deve ser definido e corretamente identificado. Nota: ver em conjunto com critério 3.1.1.", comment: "Descrição resumidada diretriz"), link: nil)

let card61 = Card(title: .Understandable, level: .AAA, code: "3.1.3", guideline: NSLocalizedString("Legível", comment: "Diretriz"), criterion: NSLocalizedString("Palavras incomuns", comment: "Critério de Sucesso"), description: NSLocalizedString("Caso use palavras técnicas ou jargões, forneça um glossário ou explicações que informem ao usuário seu significado.", comment: "Descrição resumidada diretriz"), link: nil)
